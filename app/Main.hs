  ...
  let 
    ...
    fn imgX imgY = 
        ...
        in case intersection of
            Nothing -> P.PixelRGB8 128 0 0
            Just location -> P.PixelRGB8 (fromIntegral r) (fromIntegral g) (fromIntegral b)
              where (r, g, b) = M.render $ M.clipColor $ M.reflectedLight material lights ambientLight (V.normalize location) (V3 x y 10) location
...
material = M.PhongMaterial (M.Color 0.1 0.1 0.1) (M.Color 0.3 0.3 0.3) (M.Color 0.7 0.7 0.7) 10
