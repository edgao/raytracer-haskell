...
unitTests = testGroup
  ...
  [
    ...
    testCase "Normalize" $ assertVecEqual "" (V3 (2/7) (3/7) (6/7)) (V.normalize (V3 2 3 6)) 0.0001,
    testCase "Simple reflection" $ assertVecEqual ""
      (V3 0.57735 0.57735 0.57735)
      (V.reflect (V.normalize (V3 1 1 (-1))) (V3 0 0 1))
      0.0001,
    testCase "Angled reflection 1" $ assertVecEqual ""
      (V3 0.2357 0.2357  0.942809)
      (V.reflect (V.normalize (V3 (-1) (-1) 0)) (V.normalize (V3 1 1 1)))
      0.0001,
    testCase "Angled reflection 2" $ assertVecEqual ""
